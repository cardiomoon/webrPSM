#'Sample Data for test MatchIt package
#'
...
#'  \item{Y_B}{binary outcome}
#'  \item{Y_S}{survival outcome}
#'}
#'@source \url{https://cran.r-project.org/web/packages/MatchIt/vignettes/estimating-effects.html}
"exData"
